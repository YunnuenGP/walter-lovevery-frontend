...
export default function Home() {
  const { data: banner, error, isLoading } = useMediaBanner();
  ...
  return (
    <section className="flex flex-1 flex-col">
      <MediaBanner orientation={banner.orientation}>
        <MediaBanner.Content className="flex h-full w-full flex-1 flex-col items-center justify-evenly bg-gray-200 text-center dark:bg-gray-600 tablet:items-start tablet:py-[5vw] tablet:text-start">
